  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="#">HTML</a></li>
          <li class="dropdown">
              <a class="dropdown-toggle" href="#" data-toggle="dropdown">PHP<span class="caret"></a>
                <ul class="dropdown-menu">
                  <li><a href="#">PHP-Function</a></li>
                  <li><a href="#">PHP-MYSQL</a></li>
                  <li><a href="#">PH-Loop</a></li>
      ...
      <div class="panel-group" id="myaccordion">
        ...
        <div class="panel panel-danger">
          ...
          <div class="collapse panel-collapse" id="colap2">
            <div class="panel-body">
              <img src="https://pbs.twimg.com/media/F4LozrQbYAA9lE1.jpg">
            </div>
          </div>
        </div>
        ...
        <div class="panel panel-warning">
          ...
          <div class="collapse panel-collapse" id="colap4">
            <div class="panel-body">
              <img src="https://i.pinimg.com/236x/31/ee/8c/31ee8cf175d26d71d01e471bdad33af9.jpg">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="list-group">
        ...
        <a href="#" class="list-group-item list-group-item-success">Div List Element</a>
        <a href="#" class="list-group-item list-group-item-warning">Div List Element</a>
     ...
     <div class = "container">
      ...
      <div class="container">
        ...
        <div id="dtx" class="collapse in"><img src="https://pbs.twimg.com/media/F4LozrQbYAA9lE1.jpg"></div>
